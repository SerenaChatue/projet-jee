...
CREATE TABLE amitie (
  IdAmitie INT				NOT NULL  GENERATED BY DEFAULT AS IDENTITY,
  sender_id INTEGER,
  receiver_id INTEGER,
  demande_envoyee BOOLEAN,
  demande_acceptee BOOLEAN,
  FOREIGN KEY (sender_id) REFERENCES utilisateur(idCompte),
  FOREIGN KEY (receiver_id) REFERENCES utilisateur(idCompte),
...
CREATE TABLE emprunt (
	...
	IdPreteur		INT				NOT NULL,
	IdEmprunteur INT NOT NULL,
	DateEmprunt			DATE		NOT NULL,
	Delai		INT				NOT NULL,
	FOREIGN KEY (IdOuvrage) REFERENCES ouvrage (IdOuvrage),
	FOREIGN KEY (IdPreteur) REFERENCES utilisateur (IdCompte),
	FOREIGN KEY (IdEmprunteur) REFERENCES utilisateur (IdCompte),
